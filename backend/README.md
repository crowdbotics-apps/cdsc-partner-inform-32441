...
## Project Structure
    ...
    ├── cdsc_partner_inform_32441  # Django project configurations
...
1. Clone this repo and `cd cdsc_partner_inform_32441`
...
2. Clone this repo and `cd cdsc_partner_inform_32441`
